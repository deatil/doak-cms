...
CREATE TABLE `cms_art` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文章';
...
INSERT INTO `cms_tag` VALUES (1,'八卦','八卦',101,1,1655823356,'127.0.0.1');
