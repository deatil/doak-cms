...
$.fn.Huploadify = function(opts){
    ...
    this.each(function(){
        ...
        var btnClass = option.btnClass ? option.btnClass : 'uploadify-btn';
        ...
        inputStr += '"/>';
        inputStr += '<a id="file_upload_'+instanceNumber+'-button" href="javascript:void(0)" class="uploadify-button ' +btnClass+ '">';
